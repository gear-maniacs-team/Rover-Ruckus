...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    public void setListener(@Nullable GoldAlignListener listener) {
    ...
    public interface GoldAlignListener {
        void onAlignChange(boolean found, boolean aligned, double lastXPos, double lastYPos);
    }
}
